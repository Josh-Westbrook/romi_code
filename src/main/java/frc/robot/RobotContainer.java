...
public class RobotContainer {
  ...
  LEDcontrol led = new LEDcontrol(m_onboardIO);
  ...
  */
    ...
    speedX
        .onTrue(new InstantCommand(() -> {m_onboardIO.setGreenLed(true);}).andThen(new InstantCommand(() -> {m_onboardIO.setGreenLed(false);})));
        //.whileFalse(new InstantCommand(() -> {m_onboardIO.setGreenLed(false);}));
